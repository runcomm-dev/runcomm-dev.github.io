...
* 제공한 **touchad-sdk-2.1.aar** 파일을 프로젝트의 libs 폴더에 넣어줍니다.
...
~~~
  ...
  2. **build.gradle(app)파일수정**
     ...
     *  dependencies 영역에 Implementation name: ’touchad-sdk-2.1’, ext: ’arr’를 추가합니다.
     *  중복된 내용은 생략 합니다.
~~~
...
dependencies {
    ...
    implementation name: 'touchad-sdk-2.1', ext: 'aar'
